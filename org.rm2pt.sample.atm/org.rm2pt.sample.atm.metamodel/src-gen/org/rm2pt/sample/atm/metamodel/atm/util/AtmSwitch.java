 ...
 * @generated
 */
public class AtmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case AtmPackage.ATM: {
			ATM atm = (ATM) theEObject;
			T result = caseATM(atm);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AtmPackage.USER: {
		...
		case AtmPackage.BANK_CLERK: {
			BankClerk bankClerk = (BankClerk) theEObject;
			T result = caseBankClerk(bankClerk);
			if (result == null)
				result = caseUser(bankClerk);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ATM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ATM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseATM(ATM object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bank Clerk</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bank Clerk</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBankClerk(BankClerk object) {
		return null;
	}
