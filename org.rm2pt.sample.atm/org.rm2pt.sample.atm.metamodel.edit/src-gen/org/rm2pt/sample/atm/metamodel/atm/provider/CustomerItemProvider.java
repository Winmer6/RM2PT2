...
/**
 * This is the item provider adapter for a {@link org.rm2pt.sample.atm.metamodel.atm.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerItemProvider extends UserItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AtmPackage.Literals.CUSTOMER__BANKCARD_OF);
			childrenFeatures.add(AtmPackage.Literals.CUSTOMER__RECEIPT_OF);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(AtmPackage.Literals.CUSTOMER__BANKCARD_OF, AtmFactory.eINSTANCE.createBankCard()));

		newChildDescriptors.add(
				createChildParameter(AtmPackage.Literals.CUSTOMER__RECEIPT_OF, AtmFactory.eINSTANCE.createReceipt()));
	}
